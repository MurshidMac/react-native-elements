...
const SpeedDial = (_a) => {
    var _b;
    var { theme, isOpen, onOpen = () => { }, onClose = () => { }, icon, openIcon, children, transitionDuration = 150, style } = _a, props = __rest(_a, ["theme", "isOpen", "onOpen", "onClose", "icon", "openIcon", "children", "transitionDuration", "style"]);
    ...
    return (<View style={[styles.container, style]}>
      <TouchableWithoutFeedback onPress={onClose}>
        ...
        StyleSheet.absoluteFillObject,
        {
            ...
            backgroundColor: Color((_b = theme === null || theme === void 0 ? void 0 : theme.colors) === null || _b === void 0 ? void 0 : _b.black)
                .alpha(0.6)
                .rgb()
                .toString(),
        },
